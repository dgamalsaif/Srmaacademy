...
export const registrationsTable = pgTable("registrations", {
  ...
  authorRole: text("author_role").notNull().default("co_author"),
...
export const researchProgramsTable = pgTable("research_programs", {
  ...
  firstAuthorSeats: integer("first_author_seats").notNull().default(1),
  firstAuthorSeatsLeft: integer("first_author_seats_left").notNull().default(1),
  coAuthorSeats: integer("co_author_seats").notNull().default(14),
  coAuthorSeatsLeft: integer("co_author_seats_left").notNull().default(14),
  status: text("status").notNull().default("open"),
  priceOriginalSar: integer("price_original_sar").notNull().default(1500),
  priceDiscountedSar: integer("price_discounted_sar").notNull().default(1000),
  ...
  researchGroupUrl: text("research_group_url").notNull().default(""),

      ...
      <section className="py-10 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-10 bg-[#EFF6FF] border border-[#0C3156]/12 rounded-2xl p-7 text-center shadow-sm">
            ...
            <p className="text-slate-500 text-sm mb-5">{localize(`فريق ${siteName || "المنصة"} جاهز للإجابة على استفساراتك خلال ساعات`, `The ${siteName || "platform"} team is ready to answer your questions within hours.`)}</p>
            <div className="flex gap-3 justify-center flex-wrap">
              <a href={`https://wa.me/${settings?.brand.whatsapp || "966562159258"}`} target="_blank" rel="noopener noreferrer" data-testid="button-special-whatsapp"
              ...
              <a href={`https://t.me/${settings?.brand.telegramUsername || "SRMAAcademy"}`} target="_blank" rel="noopener noreferrer" data-testid="button-special-telegram"

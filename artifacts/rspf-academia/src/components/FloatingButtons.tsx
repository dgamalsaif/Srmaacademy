  ...
  return (
    <div className="fixed bottom-6 left-6 z-50 flex flex-col gap-3">
      ...
      <a
        ...
        className="w-12 h-12 rounded-full bg-[#25D366] flex items-center justify-center shadow-xl hover:scale-110 transition-transform"
        title="WhatsApp +966 56 215 9258"
      >
        <svg viewBox="0 0 24 24" fill="white" className="w-6 h-6">
